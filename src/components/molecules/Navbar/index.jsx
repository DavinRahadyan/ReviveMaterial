...
//             <img src={Logo} alt="Paint Icon" className="scale-125 w-24 mb-2 md:w-36 ml-32" />
//             {/* <h1 className="text-5xl font-bold">RML</h1> */}
//           </div>
//           <div className="hidden lg:flex lg:items-center lg:space-x-10 lg:ml-10">
//             <NavLink
//               to="/"
//               className={({ isActive }) =>
//                 isActive
//                   ? "btn btn-ghost btn-lg rounded-btn bg-blue-500 text-white font-bold"
//                   : "btn btn-ghost btn-lg rounded-btn"
//               }
//               onClick={closeMenu}
//             >
//               Beranda
...
//             <Autentikasi className="hidden lg:block ml-10" closeMenu={closeMenu} />
...
//               className={({ isActive }) =>
//                 isActive
//                   ? "block px-3 py-2 rounded-md text-lg font-medium bg-blue-500 text-white"
//                   : "block px-3 py-2 rounded-md text-lg font-medium text-gray-700 hover:bg-gray-200"
//               }
//               onClick={closeMenu}
//             >
//               Beranda
    ...
    <nav className="fixed top-0 z-20 w-full bg-white shadow-lg font-poppins">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          <div className="flex items-center flex-shrink-0">
            <img src={Logo} alt="Paint Icon" className="scale-100 w-24 mb-2 md:w-36 " />
