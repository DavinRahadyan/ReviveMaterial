...
import CementIcon from "@assets/images/SemenL.jpg";
        ...
        <div className="flex flex-col items-center justify-center w-full">
          <img
            ...
            <p className="mb-5 text-black text-sm text-justify md:text-base lg:text-lg">
              ...
              estimasi semen lantai dengan memastikan ukuran panjang x lebar suatu ruangan harus sesuai dan dalam satuan meter.
            </p>
        </div>
    </div>
  );
